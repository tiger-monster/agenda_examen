...
$routes->post('/Crearcont', 'Home::crearc');
$routes->get('/obtenerCont/(:any)', 'Home::obtenerNombrec/$1');
$routes->post('/ActualizarCont', 'Home::actualizarc');
$routes->get('/eliminarcont/(:any)', 'Home::eliminarc/$1');
